...
def build_decisiontree_classifier_model():
    ...
    Returns:
        Untrained DecisionTreeClassifier model.
    '''
...
def build_k_neighbors_classifier_model():
    ...
    Returns:
        Untrained KNeighborsClassifier model.
    '''  
...
def build_catboost_classifier_model():
    ...
    Returns:
        Untrained CatBoostClassifier model.
    '''
...
def run_model(model,x_train,y_train,x_test):
     ...
     Args:
        ...
        x_test: Test feature data to generate predictions for.
